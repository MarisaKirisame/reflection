...
#define DECLARE_ALL_POSSIBLE_STATIC_VARIABLE_HELPER( R, TYPE, NAME ) \
    DECLARE_POSSIBLE_STATIC_VARIABLE( NAME )
#define DECLARE_ALL_POSSIBLE_STATIC_VARIABLE( NAME_SEQ ) \
    BOOST_PP_SEQ_FOR_EACH( DECLARE_ALL_POSSIBLE_STATIC_VARIABLE_HELPER, _, NAME_SEQ )
