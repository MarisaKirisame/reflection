...
struct has_member_variable
{
    ...
    constexpr static decltype( helper< TTYPE >::template has_member_variable< TTYPE, TTAG >( nullptr ) )
    function( void * )
...
#define DECLARE_ALL_POSSIBLE_MEMBER_VARIABLE_HELPER( R, DATA, ELEMENT ) \
    DECLARE_POSSIBLE_MEMBER_VARIABLE( ELEMENT, DATA )
#define DECLARE_ALL_POSSIBLE_MEMBER_VARIABLE( NAME_SEQ ) \
    BOOST_PP_SEQ_FOR_EACH( DECLARE_ALL_POSSIBLE_MEMBER_VARIABLE_HELPER, NAME_SEQ, NAME_SEQ )
