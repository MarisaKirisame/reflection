...
struct reflection_base
{
    ...
    struct has_member_variable_string_helper
    {
        ...
        has_member_variable_string_helper( const CRTP * that, bool & store_to ) :
            store_to( store_to ), that( that ) { }
    };
    ...
    struct has_static_variable_string_helper
    {
        ...
        has_static_variable_string_helper( const CRTP * that, bool & store_to ) :
            store_to( store_to ), that( that ) { }
    };
    ...
    struct has_static_function_string_helper
    {
        ...
        has_static_function_string_helper( const CRTP * that, bool & store_to ) :
            store_to( store_to ), that( that ) { }
    };
    template< typename ... ARG >
    bool has_static_function( const std::string & tag ) const
    {
        ...
        string_to_tag(
            tag,
            has_static_function_string_helper< ARG ... >( static_cast< const CRTP * >( this ), ret ) );
        return ret;
    }
    template< typename ... ARG >
    struct has_member_function_string_helper
    {
        ...
        has_member_function_string_helper( const CRTP * that, bool & store_to ) :
            store_to( store_to ), that( that ) { }
    };
    ...
    struct call_static_function_string_helper
    {
        ...
        call_static_function_string_helper( const CRTP * that, const ARG & ... a ) :
            that( that ), data( std::addressof( a ) ... ) { }
        template< typename TAG >
    ...
    void call_static_function( const std::string & str, const ARG & ... r ) const
    {
        string_to_tag(
            str,
            call_static_function_string_helper< ARG ... >( static_cast< const CRTP * >( this ), r ... ) );
    }
    template< typename CPS >
    void get_static_variable( const std::string & tag, const CPS & k ) const
    {
        string_to_tag(
            tag,
            get_static_variable_string_helper< CPS >( static_cast< const CRTP * >( this ), k ) );
    }
    ...
    bool has_member_function( const std::string & tag ) const
    {
        ...
        string_to_tag(
            tag,
            has_member_function_string_helper< ARG ... >( static_cast< const CRTP * >( this ), ret ) );
        return ret;
    }
    template< typename CPS >
    ...
    void static_variable_type( const std::string & tag, const K & k ) const
    {
        string_to_tag(
            tag,
            static_variable_type_string_helper< K >( static_cast< const CRTP * >( this ), k ) );
    }
    template< typename ... ARG >
    struct static_function_return_type_string_delegate
    {
        ...
        struct inner
        {
            ...
            template< typename TAG >
            void operator( )( const TAG & ) const
            { that->template static_function_return_type< TAG, ARG ... >( )( t ); }
            inner( const CRTP * that, const T & t ) : that( that ), t( t ) { }
        };
        template< typename T >
        void operator( )( const T & t ) const { string_to_tag( tag, inner< T >( that, t ) ); }
        static_function_return_type_string_delegate( const CRTP * that, const std::string & tag ) :
            that( that ), tag( tag ) { }
    };
    template< typename ... ARG >
    static_function_return_type_string_delegate< ARG ... >
    static_function_return_type( const std::string & tag ) const
    {
        return static_function_return_type_string_delegate< ARG ... >(
    ...
    struct member_function_return_type_string_delegate
    {
        ...
        struct inner
        {
            ...
            template< typename TAG >
            void operator( )( const TAG & ) const
            { that->template member_function_return_type< TAG, ARG ... >( )( t ); }
            inner( const CRTP * that, const K & t ) : that( that ), t( t ) { }
        };
        template< typename T >
        void operator( )( const T & t ) const { string_to_tag( tag, inner< T >( that, t ) ); }
        member_function_return_type_string_delegate( const CRTP * that, const std::string & tag ) :
            that( that ), tag( tag ) { }
    };
    template< typename ... ARG >
    member_function_return_type_string_delegate< ARG ... >
    member_function_return_type( const std::string & tag ) const
    {
        return member_function_return_type_string_delegate< ARG ... >(
                static_cast< const CRTP * >( this ),
                tag );
    }
    template< typename ... ARG >
    void call_member_function( const std::string & tag, const ARG & ... r )
    {
        string_to_tag(
            tag,
            call_member_function_string_helper< ARG ... >( static_cast< CRTP * >( this ), r ... ) );
    }
    template< typename ... ARG >
    struct call_member_function_string_helper
    {
        CRTP * that;
        std::tuple< typename std::add_pointer< const ARG >::type ... > data;
        call_member_function_string_helper( CRTP * that, const ARG & ... a ) :
            that( that ), data( std::addressof( a ) ... ) { }
        template< typename TAG >
        void operator ( )( const TAG & ) const { func< 0, TAG >( ); }
        template< int i, typename T, typename ... AARG >
    ...
    void member_variable_type( const std::string & tag, const K & k ) const
    {
        string_to_tag(
            tag,
            member_variable_type_string_helper< K >( static_cast< const CRTP * >( this ), k ) );
    }
    template< typename TAG, typename ... ARG >
    void call_member_function( const ARG & ... r )
    { call_member_function_loop< TAG >( r ..., loop_tag( ) ); }
    ...
    template< typename TAG, typename ... ARG >
    void call_static_function( const ARG & ... r ) const
    { call_static_function_loop< TAG >( r ..., loop_tag( ) ); }
    template< typename TAG, typename T, typename ... ARG >
    ...
    struct member_function_return_type_delegate
    {
        ...
        { that->template member_function_return_type_inner< TAG, K, ARG ... >( k ); }
    ...
    { k( tag< typename ::member_function_return_type< CRTP, TAG, ARG ... >::type >( ) ); }
    template< typename TAG, typename K, typename ... ARG >
    void static_function_return_type_inner( const K & k ) const
    { k( tag< typename ::static_function_return_type< CRTP, TAG, ARG ... >::type >( ) ); }
    template< typename TAG, typename ... ARG >
    struct static_function_return_type_delegate
    {
        ...
        template< typename K >
        void operator( )( const K & k ) const
        { that->template static_function_return_type_inner< TAG, K, ARG ... >( k ); }
